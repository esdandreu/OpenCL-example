...
static cl::Program build_program(const cl::Context& context, const std::string& name) {
...
// /*
//  *
//  * This code is released under the "attribution CC BY" creative commons
//  license.
...
//  * Contributors include Simon McIntosh-Smith, James Price, Tom Deakin and
//  Mike O'Connor.
//  *
//  */
